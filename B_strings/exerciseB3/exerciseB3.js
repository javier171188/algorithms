...
const WORDS = ["a",
    ...
    "yourself",
    "youth",
    "zone", "atom", "bomb", "meals", "males", "saint", "satin",
    ...
    "mash", "hams", "act", "cat", "case", "aces", "note", "tone", "tar", "rat",
...
function findAnagram(word) {
    ...
    let permutation = '';
    let anagram = undefined;

    startSearchAnagram(word);

    return anagram;
    function startSearchAnagram(word) {
        if (word.length < 2) return;
        if (word.length === 2) {
            if (WORDS.includes(permutation + word[0] + word[1]) &&
                originalWord !== permutation + word[0] + word[1]) {
                anagram = permutation + word[0] + word[1];
            }
            if (WORDS.includes(permutation + word[1] + word[0]) &&
                originalWord !== permutation + word[1] + word[0]) {
                anagram = permutation + word[1] + word[0];
            }
            return;
        }
        ...
        for (let i = 0; i < word.length; i++) {
            ...
            permutation += word[i];
            startSearchAnagram(word.slice(0, i) + word.slice(i + 1,));
